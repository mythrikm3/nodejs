...
exports.ionicRemoteConfig = exports.cordovaNode = exports.addAuth = exports.EXPRESS = exports.IONIC_ANGULAR = exports.VUE3_TS = exports.VUE3 = exports.VUE_TS = exports.VUE = exports.REACT_NATIVE = exports.REACT_TS = exports.REACT = exports.ANGULAR = void 0;
...
const IONIC_CAPACITOR_SPLASH_SCREEN_VERSION = sdk_versions_json_1.dependencies['@capacitor/splash-screen'];
...
const AUTH0_ANGULAR_VERSION = sdk_versions_json_1.dependencies['@auth0/auth0-angular'];
function addPackageJsonDependencies(framework, options) {
    return (host, context) => {
        const dependencies = [];
        if (framework === exports.ANGULAR) {
            if (options.auth0) {
                dependencies.push({ type: dependencies_1.NodeDependencyType.Default, version: AUTH0_ANGULAR_VERSION, name: '@auth0/auth0-angular' });
            }
            else {
            ...
            const authJsVersion = (framework === exports.VUE || framework === exports.VUE_TS) ? OKTA_AUTH_JS_VERSION_VUE2 : OKTA_AUTH_JS_VERSION;
            dependencies.push({ type: dependencies_1.NodeDependencyType.Default, version: oktaVueVersion, name: '@okta/okta-vue' });
            dependencies.push({ type: dependencies_1.NodeDependencyType.Default, version: authJsVersion, name: '@okta/okta-auth-js' });
        }
            ...
            if (options.platform === 'capacitor') {
                dependencies.push({ type: dependencies_1.NodeDependencyType.Default, version: IONIC_CAPACITOR_SPLASH_SCREEN_VERSION, name: '@capacitor/splash-screen' });
...
function getFramework(host) {
    ...
    if (configBuffer === null) {
        ...
        if (content.dependencies['@angular/core'] && !content.dependencies['@ionic/angular']) {
            ...
            const currentVersion = (_a = (0, coerce_1.default)(vueVersion)) === null || _a === void 0 ? void 0 : _a.version;
            const vue3 = (currentVersion) ? (0, satisfies_1.default)(currentVersion, '>=3.0.0') : false;
            if (vue3) {
...
function addAuth(options) {
    return (host) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (options.auth0) {
            if (framework !== exports.ANGULAR) {
                throw new schematics_1.SchematicsException(`Auth0 support is only available for Angular!`);
            }
            else {
        ...
        if (framework === exports.ANGULAR) {
            ...
            (0, schematics_2.addModuleImportToModule)(host, projectPath + '/src/app/app.module.ts', 'AuthRoutingModule', './auth-routing.module');
        }
        if (framework == exports.IONIC_ANGULAR) {
            ...
            if (options.platform === 'cordova') {
                ...
                (0, schematics_2.addModuleImportToModule)(host, 'src/app/app.module.ts', 'IonicStorageModule.forRoot()', '@ionic/storage-angular');
            ...
            // add imports to app.module.ts
            (0, schematics_2.addModuleImportToModule)(host, 'src/app/app.module.ts', 'HttpClientModule', '@angular/common/http');
            (0, schematics_2.addModuleImportToModule)(host, 'src/app/app.module.ts', 'AuthModule', './auth/auth.module');
    ...
    "src/app/tabs/tabs.module.ts"`);
        ...
        const sourcePath = (0, core_1.join)((0, core_1.normalize)(projectPath), sourceDir);
        const templatesPath = (0, core_1.join)(sourcePath, '');
        const templateSourcePath = `./${options.auth0 ? 'auth0/' : ''}${framework}/${sourceDir}`;
        const templateSource = (0, schematics_1.apply)((0, schematics_1.url)(templateSourcePath), [
        ...
        return (0, schematics_1.chain)([
            options && options.skipPackageJson ? (0, schematics_1.noop)() : addPackageJsonDependencies(framework, options),
